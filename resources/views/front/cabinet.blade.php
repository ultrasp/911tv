...
<div class="remodal-wrapper remodal-is-closed" style="display: none;">
	<div class="remodal any-modal mac remodal-is-initialized remodal-is-closed" data-remodal-id="mac-change-popup" data-remodal-options="hashTracking: false" tabindex="-1">
		<button data-remodal-action="close" class="remodal-close"></button>
    	<div class="box-tb-padding-25">
			<div class="any-form invert">
				<form class="mac-form" id="mac-form" action="{{route('front.savemac')}}">
					<div class="any-form cabinet m-0 invert">
						<div class="field-wrapper column box-t-margin-5 box-b-margin-25">
							<h3 class="heading-h3">Мак адрес вашего устройства</h3>
							<div id="mac-message" class="tt-a-l notification">
								
							</div>
						</div>
						<p class="w-100 label box-b-margin-25">
							<span id="mac-content-span">
								<label class="field-label">Введите мак адрес</label>
								<input class="styled tt-a-c" required="required" type="text" id="mac_adres" value="{{ ($user->mac) ? $user->mac->mac : ''}}">
							</span>
						</p>
						<p class="w-100 sbmt tt-a-l">
							<span>
