		...
		<div class="container w1170">
			<div class="content-wrapper">
				<div style="margin-top: 30px">
					<div id="video" style="width: 60%; margin: auto;padding: 10px;" data-url="aHR0cDovL3RvcGNoYW50di5uZXQ6MzQ1Ni9saXZlL3RvcGNoYW50di5uZXQvRGx5YVNheXRhU3J0ZWFtLzYubTN1OA=="></div>
				</div>
			</div>
		</div>
	</section>
...
<script>
	...
	var player = new Playerjs({id:"video",file:"js/playlist_video222.txt"});
</script>
